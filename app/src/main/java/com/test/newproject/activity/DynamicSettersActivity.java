...
public class DynamicSettersActivity extends BaseActivity implements OnDateLongClickListener {
    @InjectView(R.id.calendarView)
    MaterialCalendarView widget;
    @InjectView(R.id.animate_mode_transition)
    ...
    public int getLayoutId() {
        return R.layout.activity_dynamic_setters;
    }

    public static void actionStart(Context context) {
        Intent starter = new Intent(context, DynamicSettersActivity.class);
